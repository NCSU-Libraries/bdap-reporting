...
1. Replace the path to your logical directory, and then run this command: `docker run -v /path/to/logical:/logical -it bd-reports bash -c "python3 file_path_pii.py"`
